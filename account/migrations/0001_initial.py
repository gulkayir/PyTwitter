    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ImageField(blank=True, null=True, upload_to='uploads/headers')),
        ...
        migrations.AddConstraint(
            model_name='following',
            constraint=models.CheckConstraint(check=models.Q(('user_id', django.db.models.expressions.F('following_user_id'))), name='self_not_follow'),
        ),
    ]
